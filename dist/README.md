...
|微信|13|<li>分段广告-朋友圈广告<li>功能类-登录自动授权<li>功能类-自动领取微信红包<li>分段广告-订阅号文章广告<li>功能类-自动选中发送原图<li>功能类-自动查看原图/原视频<li>全屏广告-小程序部分通用广告<li>分段广告-小程序-内部广告<li>功能类-青少年模式自动点击验证密码<li>功能类-订阅号-展开更早的消息<li>分段广告-订阅号消息页面广告<li>功能类-付款后自动点击完成/返回商家<li>功能类-自动语音转文字|
|微信读书|1|<li>权限提示-通知权限|
