...
|哔哩哔哩|9|<li>分段广告-动态推荐广告卡片<li>分段广告-视频卡片广告<li>局部广告-视频页广告<li>局部广告-直播间悬浮窗广告<li>分段广告-搜索结果广告<li>功能类-自动关闭故事模式<li>功能类-自动点击评论区的[展开更多评论]<li>功能类-自动领取会员经验<li>功能类-自动点击查看原图|
|哔哩哔哩漫画|1|<li>青少年模式|
...
|支付宝|11|<li>通知提示-关闭花呗,借呗,还款升级,推荐等弹窗<li>更新提示<li>全屏广告-设置支付宝小组件<li>分段广告-小程序-12306<li>功能类-支付后自动点击完成<li>分段广告-出行扫码广告<li>功能类-关闭免密支付开关<li>分段广告-服务消息页面-卡片广告<li>全屏广告-弹窗广告<li>功能类-自动授权登录<li>功能类-无法访问时点击[返回]|
