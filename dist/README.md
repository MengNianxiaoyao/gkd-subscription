...
|X|3|<li>分段广告-信息流广告<li>功能类-自动点击翻译<li>功能类-自动点击"显示更多帖子"|
...
|哔哩哔哩|10|<li>分段广告-动态推荐广告卡片<li>分段广告-视频卡片广告<li>局部广告-视频页广告<li>局部广告-直播间悬浮窗广告<li>分段广告-搜索结果广告<li>功能类-自动关闭故事模式<li>功能类-自动点击评论区的[展开更多评论]<li>功能类-自动领取会员经验<li>功能类-自动点击查看原图<li>功能类-登录授权|
|哔哩哔哩漫画|1|<li>青少年模式|
